  ...
  return (
    <div className="bg-gray-950 w-full p-8  ">
      <div className="flex flex-col  sm:flex-row gap-2 justify-center items-center sm:items-start ">
        <div className="footerhead w-75 sm:w-[25%] text-center">
          ...
          <p className="text-[12px] lg:text-[16px]  text-neutral-400  ">
            Paste any YouTube URL and turn it into a custom playlist instantly.
            Whether it's a single video, channel, or entire playlist, Stack Play
            organizes it for you clean, simple, and fast.
          </p>
        </div>
        <div className=" w-75 sm:w-[25%] flex flex-col items-center text-center ">
          ...
          <div className="flex flex-col gap-2 ">
            <Link
              to={"/"}
              className="text-[12px] lg:text-sm text-neutral-400 no-underline  "
            >
              Landing
            </Link>
            <Link
        ...
        <div className=" w-75 sm:w-[25%] text-center  ">
          ...
          <p className="text-[12px] lg:text-sm text-neutral-400">
            React Bootstrap
          </p>
          <p className="text-[12px] lg:text-sm text-neutral-400">
            React Router
        ...
        <div className=" w-75 sm:w-[25%] text-center">
          ...
          <div className="searchbar flex gap-2 w-[80%] sm:w-full mx-auto">
            <input
              type="email"
              className="rounded-xl w-full h-10 px-2"
      ...
      <aside className="flex gap-2 justify-center mb-0  ">
        ...
        <p className="my-auto text-sm sm:text-lg">
